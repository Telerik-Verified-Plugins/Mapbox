...
public class CDVMapbox extends CordovaPlugin implements ViewTreeObserver.OnScrollChangedListener {
    ...
    public boolean execute(final String action, final CordovaArgs args, final CallbackContext callbackContext) throws JSONException {
        ...
        try {
            ...
            if (!map.isReady()) {
                callbackContext.error(action + " map is not loaded yet");
                return false;
            }
            ...
            if (ACTION_HIDE.equals(action)) {
                ...
                _activity.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            center.put("lat", latLng.getLatitude());
                            center.put("lng", latLng.getLongitude());
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
...
/*            try {
              ...
              callbackContext.error(e.getMessage());
                    ...
                    public void run() {
                        try{
                            ...
                            if("REGION_IS_CHANGING".equals(listener)
                                    ...
                                    || "WILL_START_RENDERING_FRAME".equals(listener)
                                    ...
                                    public void run() {
                                        try {
                                            JSONObject json = new JSONObject()
                                                    .put("cameraPosition", mapCtrl.getJSONCameraScreenPosition())
                                                    .put("markersPositions", mapCtrl.getJSONMarkersScreenPositions());
                ...
                _activity.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            callbackContext.success(mapCtrl.getJSONCameraScreenPosition());
                        } catch (JSONException e){
                            callbackContext.error(e.getMessage());
                            e.printStackTrace();
                        }
